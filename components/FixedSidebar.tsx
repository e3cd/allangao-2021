  ...
  return (
    <div className="w-full lg:w-2/5">
      <div className="flex flex-col w-full pr-8 py-16 mx-auto lg:pl-16  mt-4 lg:mt-32 ">
        ...
        <p className="mb-8 text-base leading-snug text-left tracking-relaxed lg:text-2xl lg:pr-10 text-paragraphLight dark:text-mediumGrey lg:text-left lg:text-1xl">
